        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">
              <img class="image" src="{{ url('http://127.0.0.1:8000') . $data->logo }}" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-scroll-nav="2" href="#">Login</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
          <div class="col-lg-6 col-md-10">
            <div class="header-hero-content">
              ...
              <p class="text wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.4s"> {{ $data->hero_subtitle }}  </p>
              <ul class="d-flex justify-content-center">
                <li><a href="#contactUs" class="main-btn wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.8s">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="header-image">
              <img src="{{ url('http://127.0.0.1:8000') . $data->hero_app_image }}" alt="" class="image-1  wow fadeInRightBig"
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-6 col-md-9">
          <div class="download-image mt-50 wow fadeInLeftBig" data-wow-duration="3s" data-wow-delay="0.5s">
            ...
            <img src="{{ url('http://127.0.0.1:8000') . $data->download_app_image }}" alt="" class="image-3">
          </div>
        </div>
        <div class="col-lg-6">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            <div class="footer-about mt-50">
              ...
              <ul class="social">
                <li><a href="https://www.facebook.com/avatarsolution"><i class="fab fa-facebook-f"></i></a></li>
                <li><a href="https://twitter.com/avatarsolution"><i class="fab fa-twitter"></i></a></li>
                <li><a href="https://www.instagram.com/avatarsolution"><i class="fab fa-instagram"></i></a></li>
                <li><a href="https://www.linkedin.com/company/avatar-solutions"><i class="fab fa-linkedin-in"></i></a></li>
              </ul>
            </div>
          </div>
